...
Public Class frmExperiment
    ...
    Private Sub SelectConsequence(strLeverName As String)
        ...
        Select Case strLeverName
            Case "Target"
                ...
                If tmrTimeOut.Enabled = False Then '7/30/2024 moved this to before m_boolTimeOut if
                    m_intTargetPress += 1
    ...
    Private Sub WriteDataFile()
        ...
        swWriteResults.WriteLine("7 = Start of Consummatory Response")
        swWriteResults.WriteLine("8 = End of Consummatory Response")
